...
ChatService::ChatService()
{
    ...
    _msgHandlerMap.insert({PRIVATE_CHAT_MSG, std::bind(&ChatService::privateChat, this, _1, _2, _3)});
...
// 处理登录业务     ORM     业务层操作的都是对象    DAO     // id   pwd
...
void ChatService::privateChat(const TcpConnectionPtr &conn, json &js, Timestamp time)
{
...

    {
        ...
        if (it != _userConnMap.end()) // toid在线，转发消息
        {
            // 服务器主动推送消息给toid用户
